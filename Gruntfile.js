...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			expense:{
				...
				src:[
					...
					'js/input.plugin.js',
					'js/mui.number.js',
					'wechat/expense/js/mui.previewimage.js',
					'wechat/expense/js/mui.view.js',
					'wechat/expense/js/mui.zoom.js',
					'wechat/expense/js/mui.utils.js',
					'wechat/expense/js/template.js',
					// 'wechat/expense/js/zepto.js',
					'wechat/expense/js/report.js',
				],
				dest:'wechat/expense/report.js'
			}
		},
		...
		uglify: {
			...
			expense:{
				src:'<%= concat.expense.dest %>',
				dest:'wechat/expense/dist/report.min.js'
			}
		},
			...
			wechat:{
				options:{
					removeComments: true, // 删除注释
 					minifyJS:true,//压缩文件内的JS代码
					minifyCSS:true,// 压缩文件内的CSS
					collapseWhitespace:true,// 删除html的空格和空行，
					removeIgnored:true
				},
				files:{
					"wechat/expense/dist/report.html": "wechat/expense/report.html"
				}
			}
		}
	});
	...
	grunt.registerTask('wechat',['concat:expense','uglify:expense','htmlmin:wechat']);
